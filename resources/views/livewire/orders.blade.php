...
<div>
    ...
    <div x-data="{ open: @entangle('showCreate') }">
        <x-modal-lg confirmText="{{ __('Next') }}" action="showOrderSummary" :clickAway="false">
            ...
            <x-select title="{{ __('Package Type') }}" :options='$packageTypes ?? []' name="name" :defer="false" />
            <x-select title="{{ __('Vendor') }}" :options='$vendors ?? []' name="name" :defer="false" />
            @else
            ...
            <a class="text-primary" href="{{route('delivery.addresses')}}"><x-buttons.primary class="btn btn-primary">Add new address</x-buttons.primary></a>
            @endif
